      ...
      <div className="our-team-section">
        ...
        <div className="team-cards">
          ...
          <div className="team-card">
            <div className="team-card-background" style={{ backgroundImage: 'url(/Images/person1.jpg)' }}></div>
          ...
          <div className="team-card">
            <div className="team-card-background" style={{ backgroundImage: 'url(/Images/person2.jpg)' }}></div>
            <div className="team-card-content">
              <h3>Maheshwari</h3>
